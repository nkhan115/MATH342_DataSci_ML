...
#We cannot indefinitely say we are getting 'dumber.' You would first need to clearly define what metrics you are using
#to measure vocab and ageGroup. 
```
...
#I don't know why it prints 'list' instead of actual lists
```
...
'''
According to the ones I saw in class, vanilla did fairly well. Maybe because of its approximation to income?
'''

What is wrong with this model selection procedure? There are a few things wrong.

'''Perhaps if we added more features than we can have a more accurate brier score.'''
