...
rand_list <- strsplit(lorem, ".")
sample(rand_list, length(rand_list),replace=FALSE, prob=NULL)
...
```{r}
#HINT: 
list1 <- strsplit("Theodore, Bernard, Gene, Herbert, Ray, Tom, Lee, Alfred, Leroy, Eddie", split = ", ")
list2 <- strsplit("M, F", split = ",")
list3 <- strsplit("Boomer, GenX, Millenial", split=",")
...
#' This function uses the k-nearest neighbor algorithm
#' @param Xinput      This data trains as a matrix
#' @param y_binary    This data trains as a vector
#' @param Xtest       This data tests the matrix
#' @return            returns the parameter as a vector
